...
export const useLoginByGoogleMutation = createMutationHook(
  "login",
  "/auth/google"
);
...
export const useRefreshMutation = createMutationHook(
  "refresh",
  "/auth/refresh"
);

export const useForgetPasswordMutation = createMutationHook(
  "forget-password",
